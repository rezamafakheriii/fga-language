...
[![Go Reference](https://pkg.go.dev/badge/github.com/revotech-group/fga-language.svg)](https://pkg.go.dev/github.com/revotech-group/fga-language/pkg/go)
[![GitHub Release](https://img.shields.io/github/v/release/openfga/language?include_prereleases&filter=pkg%2Fgo%2Fv*&label=openfga-language)](https://github.com/revotech-group/fga-language/tree/main/pkg/go)

## Installation

```bash
go get github.com/revotech-group/fga-language/pkg/go
```
...
```go
import "github.com/revotech-group/fga-language/pkg/go/transformer"
...
Not yet implemented, but the [feature is in our issue backlog](https://github.com/revotech-group/fga-language/issues/99).
