...
[![GitHub Release](https://img.shields.io/github/v/release/openfga/language?include_prereleases&filter=pkg%2Fgo%2Fv*&label=go%20release)](https://github.com/revotech-group/fga-language/tree/main/pkg/go)
...
| Go       | [![GitHub Release](https://img.shields.io/github/v/release/openfga/language?include_prereleases&filter=pkg%2Fgo%2Fv*&label=openfga-language)](https://github.com/revotech-group/fga-language/tree/main/pkg/go)                           | [README](/pkg/go/README.md)   |
...
| ---------- | ------------------------------------------------------------------------ |
| Basic DSL  | ✅                                                                       |
| Nesting    | ✅ (partial, see [#113](https://github.com/revotech-group/fga-language/issues/113)) |
| Conditions | ✅                                                                       |
...
| Semantic Model Validations                            | ❌ (planned, see [#99](https://github.com/revotech-group/fga-language/issues/99)) | ✅                                                                                                      | ✅           |
...
This project is licensed under the Apache-2.0 license. See the [LICENSE](https://github.com/revotech-group/fga-language/blob/main/LICENSE) file for more info.
