...
[![GitHub Release](https://img.shields.io/github/v/release/openfga/language?include_prereleases&filter=pkg%2Fgo%2Fv*&label=go%20release)](https://github.com/revotech-group/language/tree/main/pkg/go)
...
| Go       | [![GitHub Release](https://img.shields.io/github/v/release/openfga/language?include_prereleases&filter=pkg%2Fgo%2Fv*&label=openfga-language)](https://github.com/revotech-group/language/tree/main/pkg/go)                           | [README](/pkg/go/README.md)   |
...
| ---------- | ------------------------------------------------------------------------ |
| Basic DSL  | ✅                                                                       |
| Nesting    | ✅ (partial, see [#113](https://github.com/revotech-group/language/issues/113)) |
| Conditions | ✅                                                                       |
...
| Semantic Model Validations                            | ❌ (planned, see [#99](https://github.com/revotech-group/language/issues/99)) | ✅                                                                                                      | ✅           |
